...
Entity::Entity() : mPosition {0.0f, 0.0f}, mMovement {0.0f, 0.0f}, 
                   ...
                   mTexture {}, mTexturePath {}, mTextureType {SINGLE}, 
                   mAngle {0.0f}, mSpriteSheetDimensions {}, mDirection {RIGHT}, 
...
{
    mTexturePath = textureFilepath ? textureFilepath : "";
}
...
Entity::Entity(const Entity& other) : mPosition {other.mPosition},
        mMovement {other.mMovement}, mVelocity {other.mVelocity}, 
        mAcceleration {other.mAcceleration}, mScale {other.mScale}, 
        mColliderDimensions {other.mColliderDimensions}, 
        mTextureType {other.mTextureType}, mTexturePath {other.mTexturePath}, 
        mSpriteSheetDimensions{other.mSpriteSheetDimensions},
        mAnimationAtlas {other.mAnimationAtlas}, mAnimationIndices {other.mAnimationIndices}, 
        mDirection {other.mDirection}, mFrameSpeed {other.mFrameSpeed}, 
        mCurrentFrameIndex {other.mCurrentFrameIndex}, mAnimationTime {other.mAnimationTime}, 
        mSpeed {other.mSpeed}, mAngle {other.mAngle}, mEntityStatus {other.mEntityStatus}, 
        mEntityType {other.mEntityType}
{
    if (!mTexturePath.empty()) mTexture = LoadTexture(mTexturePath.c_str());
    else                       mTexture = {};
}
